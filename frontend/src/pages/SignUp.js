    ...
    <div className='mx-auto container p-5'>
            ...
            <div className='w-20 h-20 mx-auto'>
              ...
              <div className='grid'>
                     ...
                     <input type='text' name='name' value={data.name} onChange={handleOnChange} placeholder='enter names' className=' w-full h-full outline-none bg-transparent'/> 
                     </div>
                ...
                <div>
                    ...
                    <div className=' bg-slate-100 p-2 flex'>
                     <input name='Confirmpassword' onChange={handleOnChange}  value={data.Confirmpassword} type={showConPassword ? "" : "password"} placeholder='Confirm password' className=' w-full h-full outline-none bg-transparent'/>
